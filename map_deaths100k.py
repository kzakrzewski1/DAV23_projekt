...
fig = px.choropleth_mapbox(data_total, geojson=provinces, 
                           ...
                           mapbox_style="mapbox://styles/krzysiekz2901/clhw7fi4c024w01qu4nfsgs8f",
                           zoom=3.45, center = {"lat": 80.0902, "lon": -150.7129},
                           opacity=0.45,
                           hover_name = "prname",
...
fig.update_mapboxes(bounds_east=-30, bounds_west = -176, bounds_north = 84, bounds_south = 32, center_lon = -97, center_lat = 58.6)
...
fig.write_html("Map_deaths_100K.html")
